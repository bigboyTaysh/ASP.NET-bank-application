...
namespace BankApplication.DAL
{
    public class BankInitializer : DropCreateDatabaseIfModelChanges<BankContext>
    {
        protected override void Seed(BankContext context)
        {
            ...
            {
                new BankAccount {Balance = 10.50m, AvailableFounds = 0m, Lock = 0m, BankAccountNumber = decimal.Parse("12123412341234123412341230"), CreationDate = new DateTime(2020, 06, 04), BankAccountType = bankAccountTypes[0]},
                new BankAccount {Balance = 0m, AvailableFounds = 0m, Lock = 0m, BankAccountNumber = decimal.Parse("12123412341234123412341231"), CreationDate = new DateTime(2020, 06, 03), BankAccountType = bankAccountTypes[1]}
            };
